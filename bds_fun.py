...
class bds_Func:
    ...
    def predict_obds(dt, bf, winetest):
        ...
        return acc3, arg2, count99, count111, count_s2,count_d2,count_c2,time1, path_counts,path_lengths,node_counts
            ...
            for v in range(int(0.01*len(winetest))):
                ...
                for cc in range(0, Terms, 4):
                    ...
                    for d in range(0,trees,1):
                        ...
                        alphabet_with_commas = map(bddvar, variable_names)
    ...
    def predict_obds(dt, bf, winetest):
        ...
        acc3 = correct/len(winetest)
        print(avg_test_time*1000)
        time2 = avg_test_time*1000
        #print(f1)
        #print(len(re.findall(r"\bAnd\b", str(f1))))
        #print(len(re.findall(r"\bOr\b", str(f1))))
        print('-----------------------------')
        return acc3, arg2, count99, count111,time2


        def save_bds_terms_txt(filename, and_terms):
        ...
        def save_variable_dict_txt(filename, var_dict):
